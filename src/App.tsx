...
function App() {
  return (
    <>
      ...
      <Page>
        <p></p>
        <p className="text-white font-bold text-center mt-[100px] mb-4">
        ...
        <div className="flex flex-row mt-[150px]">
          <div className="flex-1">
            <p className="font-title text-white text-3xl text-center">
      ...
      <Page>
        <div className="flex flex-col h-full justify-center">
          <div>
            ...
            <p className="text-white text-right text-sm font-bold my-2">
              QS. Ar-Rum : 21
            </p>
          </div>
        </div>
      ...
      <Page>
        <img
          src="photo.jpg"
          alt="wedding"
          className="rounded-2xl shadow-md hover:shadow-xl"
        />
        <p className="mb-10"></p>
